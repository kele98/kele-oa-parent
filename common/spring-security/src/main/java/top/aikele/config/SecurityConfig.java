...
//                .httpBasic(Customizer.withDefaults());
        ...
        http.addFilterAt(new JwtFilter(), MyUsernamePasswordAuthenticationFilter.class);
        return http.build();
    }
    //添加自定义用户认证过滤器
    @Bean
    MyUsernamePasswordAuthenticationFilter myUsernamePasswordAuthenticationFilter(){
        ...
        MyUsernamePasswordAuthenticationFilter myUsernamePasswordAuthenticationFilter = new MyUsernamePasswordAuthenticationFilter(providerManager);
